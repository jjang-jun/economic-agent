module.exports = {
  must_include: [
    ...
    '수출', '무역수지', '반도체 수출', '가계부채', '주택가격', '부동산 투자',
    '스태그플레이션', '고정자산투자', '보호무역',
    ...
    'stagflation', 'exports', 'trade surplus', 'household debt',
    'property investment', 'fixed asset investment', 'Hormuz',
  ],
  high_priority: [
    '긴급', '속보', '폭락', '폭등', '서킷브레이커',
    '금리 인하', '금리 인상', '기준금리 변경',
    '전쟁', '침공', '디폴트', '파산', '유동성 위기', '호르무즈 봉쇄',
  ],
  weight: {
    ...
    4: ['금리 인하', '금리 인상', '기준금리', 'FOMC', '금통위', 'CPI', 'PCE', '제재', '관세',
        ...
        '유가 급등', '유가 급락', '원유 급등', '유동성 위기', '호르무즈 봉쇄'],
    3: ['금리', '통화정책', '인플레이션', '환율', 'GDP', '실업률', '고용',
        '코스피', '코스닥', 'S&P', '나스닥', 'VIX',
        'Fed', 'inflation', 'recession', 'treasury', 'Trump',
        '유가', '원유', 'WTI', 'OPEC', 'oil', 'crude', '배럴',
        '스태그플레이션', '무역수지', '반도체 수출', '가계부채', '주택가격',
        'stagflation', 'trade surplus', 'household debt', 'Hormuz'],
    2: ['물가', '달러', '원화', 'PMI', 'trade war', 'bond', 'Bloomberg',
        '수출', '소매판매', '부동산 투자', '고정자산투자', 'exports', 'retail sales',
        'property investment', 'fixed asset investment'],
  },
  sentiment: {
    bullish: [
  ...
  sectors: {
    ...
    '거시경제': ['CPI', 'PCE', '물가', '인플레이션', '환율', 'GDP', 'PMI', '실업률', '고용',
                '스태그플레이션', '수출', '무역수지', '소매판매', '가계부채', '주택가격',
                'inflation', 'recession', 'unemployment', 'stagflation', 'exports',
                'trade surplus', 'retail sales', 'household debt'],
    '에너지·원자재': ['유가', '원유', 'WTI', '브렌트', 'OPEC', '석유', '배럴', '가스', 'LNG',
                     'oil', 'crude', 'energy', 'petroleum'],
    '무역·지정학': ['관세', '제재', '전쟁', 'Trump', 'tariff', 'sanction', 'trade war',
                    'executive order', 'ban', '봉쇄', '공급망', '보호무역', '호르무즈',
                    'property investment', 'fixed asset investment', 'Hormuz'],
  },
};
