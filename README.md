...
종목 추천은 단순 `매수/관찰` 문구가 아니라 기대 손익 구조를 포함해야 합니다. 장 마감 리포트는 가능한 경우 `손익비`, `손절폭`, `무효화 조건`, `제안 매수금액`, `계좌 비중`, `20일 상대강도`, `20일 평균 대비 거래량`을 함께 표시합니다. 2,000만원 계좌 기준 기본 1회 신규 매수 상한은 100만원이고, 거래 1회 손실 허용액은 20만~40만원입니다.
